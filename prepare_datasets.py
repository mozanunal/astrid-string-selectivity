...
if __name__ == "__main__":
    ...
    prepare_dataset("datasets/imdb/", "an.name")
    prepare_dataset("datasets/imdb/", "cn.name")
    prepare_dataset("datasets/imdb/", "k.keyword")
    prepare_dataset("datasets/imdb/", "mc.note")
    prepare_dataset("datasets/imdb/", "n.name")
    prepare_dataset("datasets/imdb/", "t.title")
